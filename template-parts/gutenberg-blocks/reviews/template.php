...
$post_id = get_the_ID();
$cache_key = 'reviews_block_' . $post_id;
...
if (!$data) {
    ...
    if (!empty($items)) {
        ...
        foreach ($items as $item) {
            ...
            if (empty($item['image']['ID'])) continue;
