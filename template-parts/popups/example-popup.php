                            ...
                            <?php if ($needs_ring_size): ?>
                                <div class="styled ring-size-field">
                                    ...
                                    <p class="ring-size-notice" id="ring-size-notice" hidden>
                                        ⚠️ Ви обрали нестандартний розмір — на такий виріб іде більше срібла, тож вартість буде трохи вищою. Я з радістю розрахую точну ціну й підтверджу її під час оформлення замовлення.
                                    </p>
