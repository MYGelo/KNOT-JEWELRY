...
function theme_scripts()
{
    ...
    wp_enqueue_script('ajax-filter', get_template_directory_uri() . '/assets/js/ajax-filter.js', [], null, true);
    wp_localize_script('ajax-filter', 'ajax_object', ['ajax_url' => admin_url('admin-ajax.php'),]);
